...
import (
	...
	"github.com/fiatjaf/graphql/language/kinds"
	"github.com/fiatjaf/graphql/language/visitor"
)
...
var (
	_ HasSelectionSet = (*ast.OperationDefinition)(nil)
	_ HasSelectionSet = (*ast.FragmentDefinition)(nil)
)
...
func (
	ctx *ValidationContext) RecursivelyReferencedFragments(
